        ...
        <table className="w-full text-left border-collapse min-w-full">
          <thead>
            <tr className="bg-slate-900 text-white">
              ...
              <th className="p-3 border border-slate-700 font-bold w-56 text-sm">廠牌 / 備註</th>
              <th className="p-3 border border-slate-700 font-bold no-print w-10 text-center text-sm"></th>
            </tr>
          </thead>
          <tbody className="divide-y divide-slate-200">
            ...
            <tr className="no-print">
              <td colSpan={8} className="p-4 text-center border bg-slate-50">
          ...
          <tfoot className="border-t-2 border-slate-900">
            ...
            <tr className="bg-slate-50">
              <td colSpan={5} className="p-3 text-right font-bold text-slate-500 text-sm border-r border-slate-200">小計 (材料與工資)</td>
            ...
            {/* 工程管理費 */}
            <tr className="bg-slate-50">
              <td colSpan={5} className="p-3 text-right font-bold text-slate-500 text-sm border-r border-slate-200">
            ...
            {/* 總計 */}
            <tr className="bg-slate-900 text-white">
              <td colSpan={5} className="p-4 text-right font-black uppercase tracking-[0.2em] text-xs border-r border-slate-800">總計預估金額 (含稅)</td>
